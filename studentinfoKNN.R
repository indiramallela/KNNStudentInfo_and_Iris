...
# Train the classification model (KNN with k=4)
model <- train(final_result ~ ., data = train_data, method = "knn", trControl = trainControl(method = "none"), tuneGrid = data.frame(k = 3))
